...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1525163287,11110}
...
local UserName = (data.username_ or "- 𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ")
...
if result.id_ == tonumber(1525163287) then
...
send(msg.chat_id_, msg.id_,"\n⌔┇العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "- 𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ")..")".."\n⌔┇تم رفعه "..RTPA.." هنا\n")
...
if SNAPrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔┇العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "- 𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ")..")".."\n⌔┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."SNAP:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "- 𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ")
...
local get_id = database:get(bot_id.."SNAP:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'SNAP:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
keyboard.inline_keyboard = {
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾',url="https://t.me/iinzzz"},
},
{
{text = '𝖽𝖾𝗏 𝗌𝗇𝖺𝗉',url="t.me/Yk_YY"},
},
{
{text = '𝗍𝗐𝗌 𝗌𝗇𝖺𝗉⁦',url="t.me/Y22ibot"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local keyboard = {
{'ا⌔ الاحصائيات ','⌔ تغير المطور الاساسي '},
{'⌔ تفعيل التواصل ','⌔ تعطيل التواصل '},
{'⌔ تنظيف الكروبات  ','⌔ تنظيف المشتركين '},
{'⌔ تفعيل البوت الخدمي ','⌔ تعطيل البوت الخدمي '},
{'اذاعه خاص⌔┇','⌔ المطورين  ','⌔ اذاعه '},
{'⌔ اذاعه بالتوجيه ','⌔ اذاعه بالتوجيه خاص'},
{'تفعيل ال⌔ اذاعه ','تعطيل ال⌔ اذاعه '},
...
{'- ⌔ الاشتراك الاجباري .'},
{'- تعين قناة الاشتراك⌔┇.','- ⌔ تغير رساله الاشتراك الاجباري .'},
...
if text =='⌔ تغير المطور الاساسي ' and VIP_DeV(msg) then
send(msg.chat_id_, msg.id_,'⌔┇ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'LACKBOTSS:Ed:DevBots',true) 
end
if text =='⌔ تغير المطور الاساسي ' and not VIP_DeV(msg) then
...
if text == "تفعيل ال⌔ اذاعه " then
database:del(bot_id.."SNAP:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n⌔┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل ال⌔ اذاعه " then
database:set(bot_id.."SNAP:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n⌔┇تم تعطيل الاذاعه") 
return false
end 
...
if text and text:match("^- ⌔ تغير رساله الاشتراك الاجباري .$") and DevSNAP(msg) then  
...
local Teext =[[
𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 [- 𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ](t.me/iinzzz) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
inline = {
{{text = '⌔┇𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗇𝖺𝗉 メ  .',url='http://t.me/iinzzz'}},
}
...
local Name_Bot = (database:get(bot_id.."SNAP:Name:Bot") or "سناب")
