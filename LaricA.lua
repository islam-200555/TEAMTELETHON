...
keyboard.inline_keyboard = {
{
{text = 'اوامر التنظيف', callback_data=msg.sender_user_id_.."/help0"},{text = 'اوامر الحمايه', callback_data=msg.sender_user_id_.."/help1"},
},
{
{text = 'اوامر الادمنيه', callback_data=msg.sender_user_id_.."/help2"},{text = 'اوامر المدراء', callback_data=msg.sender_user_id_.."/help3"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'اوامر التنظيف', callback_data=data.sender_user_id_.."/help0"},{text = 'اوامر الحمايه', callback_data=data.sender_user_id_.."/help1"},
},
{
{text = 'اوامر الادمنيه', callback_data=data.sender_user_id_.."/help2"},{text = 'اوامر المدراء', callback_data=data.sender_user_id_.."/help3"},
},
{
