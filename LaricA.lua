...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1573309498,1779719821}
...
var = true  
elseif tonumber(user_id) == tonumber(1779719821) then
var = true  
...
if result.id_ == tonumber(1779719821) then
...
if userid == tonumber(1779719821) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
if result.sender_user_id_ == tonumber(17797198211100) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Developer Telegram \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1779719821) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
