...
send(msg.chat_id_, msg.id_,'• عـليك الاشـتࢪاك في اشتࢪڪ هنا عمࢪي اولآ . \n• اشتࢪڪ هنا عمࢪي ←  ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end 
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."LARICA:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."LARICA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LARICA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."LARICA:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."LARICA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
*ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ*
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/LARICATEAM)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/LARICATEAM"},
},
}
