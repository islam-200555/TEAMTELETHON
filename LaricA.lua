...
if text and text:match("^معنى اسم (.*)$") and database:get(bot_id.."LaricA:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معنى اسم (.*)$")
data,res = https.request'https://apiabs.ml/Mean.php?Abs='..URL.escape(TextMean))
if res == 200 then
