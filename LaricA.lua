...
keyboard.inline_keyboard = {
{
{text = 'آوآمر الحماية', callback_data=msg.sender_user_id_.."/help1"},{text = 'آوآمر آلادمنية', callback_data=msg.sender_user_id_.."/help2"},{text = 'آوآمر آلمدرآء', callback_data=msg.sender_user_id_.."/help3"},{text = 'آوآمر آلمنشئين', callback_data=msg.sender_user_id_.."/help4"},{text = 'آوآمر آلمطورين', callback_data=msg.sender_user_id_.."/help5"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'آوآمر الحماية', callback_data=data.sender_user_id_.."/help1"},{text = 'آوآمر آلادمنية', callback_data=data.sender_user_id_.."/help2"},
},
}
{text = 'آوآمر آلمدرآء', callback_data=data.sender_user_id_.."/help3"},{text = 'آوآمر آلمنشئين', callback_data=data.sender_user_id_.."/help4"},
},
}
{text = 'آوآمر آلمطورين', callback_data=data.sender_user_id_.."/help5"},
},
}
},
{
