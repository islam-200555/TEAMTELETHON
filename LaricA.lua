...
if text == (database:get(bot_id.."LaricA:Name:Bot") or "ماتركس") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."LaricA:Name:Bot") or "ماتركس")
local namebot = {
...
tdcli_function ({ID = "GetUser",user_id_ = Sudo},function(arg,data) 
Test = '👋🏻꒐ اهلا بك في ["..Namebot.."] بوت حماية المجموعات\n⏺꒐ يمكنك اضافتي الى مجموعتك\n• [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/LaRiCaTeam)\n• معرف المطور @['..data.username_..']'
end,nil)
end 
send(msg.chat_id_, msg.id_, Test) 
end
...
local Name_Bot = (database:get(bot_id.."LaricA:Name:Bot") or "ماتركس")
