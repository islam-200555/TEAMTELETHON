...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1573309498,1884973592}
...
var = true  
elseif tonumber(user_id) == tonumber(1884973592) then
var = true  
...
if result.id_ == tonumber(1884973592) then
...
if userid == tonumber(1884973592) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
if result.sender_user_id_ == tonumber(18849735921100) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Developer Telegram \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1884973592) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
function Function_LARICATEAM(extra, result, success)
if DevLARICATEAMe(result.sender_user_id_)  then
...
if DevLARICATEAMe(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."LARICATEAM:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."LARICATEAM:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."LARICATEAM:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LARICATEAM, nil)
end
...
function Function_LARICATEAM(extra, result, success)
if (result.id_) then
if DevLARICATEAMe(result.id_)  then
send(msg.chat_id_, msg.id_,"⌔︙ لا تستطيع تنزيل مطور البوت او السورس")
return false 
end
...
if DevLARICATEAMe(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.id_)
database:srem(bot_id.."LARICATEAM:Sudo:User", result.id_)
database:srem(bot_id.."LARICATEAM:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."DEV:Sudo:T",msg.sender_user_id_) then
database:srem(bot_id.."LARICATEAM:Sudo:User", result.id_)
database:srem(bot_id.."LARICATEAM:Basic:Constructor"..msg.chat_id_,result.id_)
database:srem(bot_id.."LARICATEAM:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."LARICATEAM:Special:User"..msg.chat_id_, result.id_)
...
local namebot = {
"يروحلك فدوا "..Namebot.. " أمرني عمري؟",
" يبعدي انت ؟ اني "..Namebot,
'ها يحيلي؟ .',
'لتلح عاد نطيتك عين؟',
'يهنيالي من تصيحلي بصوتك؟',
'يمك يروحي',
'شكد احب اسمي بصوتك',
'دد لتلح؟',
'ها بربوك',
...
local Texting = {
'معيدي ولطش ع رب الصوره؟',
"يروحي شهلصورا كرشت ترا؟ ",
"ممكن علاقه مؤاقته يحلاوا؟",
"من تجيب تمبلر من كوكل.",
"ابوسجمالك؟ ",
"دد لتلح؟ ",
}
