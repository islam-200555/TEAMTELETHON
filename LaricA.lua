...
local Text =[[
اهلا بك في سورس . [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/LaRiCaTeam)
يمكنك استخدام الاوامر الموجودة 🔽
𝘊𝘩 -[LaRiCaTeam](t.me/LaRiCaTeam)•
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اوامر التنظيف', callback_data=msg.sender_user_id_.."/help0"},{text = 'اوامر الحمايه', callback_data=msg.sender_user_id_.."/help1"},{text = 'اوامر الادمنيه', callback_data=msg.sender_user_id_.."/help2"},{text = 'اوامر المدراء', callback_data=msg.sender_user_id_.."/help3"},{text = 'اوامر المنشئين', callback_data=msg.sender_user_id_.."/help4"},{text = 'اوامر المطورين', callback_data=msg.sender_user_id_.."/help5"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'اوامر التنظيف', callback_data=data.sender_user_id_.."/help0"},{text = 'اوامر الحمايه', callback_data=data.sender_user_id_.."/help1"},{text = 'اوامر الادمنيه', callback_data=data.sender_user_id_.."/help2"},{text = 'اوامر المدراء', callback_data=data.sender_user_id_.."/help3"},{text = 'اوامر المنشئين', callback_data=data.sender_user_id_.."/help4"},{text = 'اوامر المطورين', callback_data=data.sender_user_id_.."/help5"},
},
{
